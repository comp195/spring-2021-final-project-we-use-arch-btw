...
class Media:
    ...
    def __init__(self, imdbID, title, year, rating, genre, plot, rottenTomatoesRating, filePath, duration, state, playCount):
...
if __name__ == "__main__":
    ...
    m1 = Media("tt4154796", "Avengers: Endgame", "2019", "PG-13", "Action, Adventure, Drama, Sci-Fi",
               p1, "94%", "/home/user/Desktop/avengers.mp4", "181 min", State.WATCHED, 2)
    ...
    m2 = Media("tt0368226", "The Room", "2003", "R", "Drama", p2, "24%", "/home/user/Desktop/theroom.mp4", "99 min", State.UNWATCHED, 0)
    ...
    m3 = Media("tt1285016", "The Social Network", "2010", "PG-13", "Biography, Drama", p3, "96%", "/home/user/Desktop/thesocialnetwork.mp4", "120 min", State.WATCHED, 1)
    print(m1)
    m1.markUnwatched()
    print(m1)
    m1.markWatched()
